  ...
  const content = `
    ...
    <div class="content">
        ...
        <p class="small-text">
            ...
            <a href="mailto:support@saintshub.net" style="color: ${colors.primary};">support@saintshub.net</a>
        </p>
    </div>
...
// 7. Storage Upgrade Request Email (sent to admin)
export const storageUpgradeRequestTemplate = (
  userName: string,
  userEmail: string,
  currentPlan: string,
  ...
  const content = `
    <div class="header" style="background: linear-gradient(135deg, ${colors.warning} 0%, #d97706 100%);">
        ...
        <h1 class="header-title">Storage Upgrade Request</h1>
    </div>
    
    <div class="content">
        <p class="greeting">New Storage Upgrade Request</p>
        
        <p class="message">
            A user has requested a storage plan upgrade on SaintsHub. Please review and take action.
        </p>
        ...
        <div class="info-box">
            ...
            <table style="width: 100%; margin-top: 12px; border-collapse: collapse;">
                <tr>
                    <td style="padding: 6px 0; color: ${colors.text.muted}; width: 140px;"><strong>Name:</strong></td>
                    <td style="padding: 6px 0; color: ${colors.text.dark};">${userName}</td>
                </tr>
                <tr>
                    <td style="padding: 6px 0; color: ${colors.text.muted};"><strong>Email:</strong></td>
                    <td style="padding: 6px 0; color: ${colors.text.dark};">
                        <a href="mailto:${userEmail}" style="color: ${colors.primary};">${userEmail}</a>
                    </td>
                </tr>
                <tr>
                    <td style="padding: 6px 0; color: ${colors.text.muted};"><strong>Current Plan:</strong></td>
                    <td style="padding: 6px 0; color: ${colors.text.dark};">${currentPlan.toUpperCase()}</td>
                </tr>
                <tr>
                    <td style="padding: 6px 0; color: ${colors.text.muted};"><strong>Requested Plan:</strong></td>
                    <td style="padding: 6px 0; color: ${colors.primary}; font-weight: 600;">${requestedPlan.toUpperCase()}</td>
                </tr>
            </table>
        </div>
        ...
        <div class="warning-box">
            ...
            <span style="color: ${colors.text.dark}; margin-top: 8px; display: block;">${reason}</span>
        </div>
        ` : ''}
        
        <p class="message">
            <strong>To approve this request:</strong> Use the admin dashboard or API to update the user's storage plan.
        </p>
        
        <div class="divider"></div>
        
        <p class="small-text">
            This notification was sent to the SaintsHub admin.
            <br>Manage storage plans at 
            <a href="https://saintshub.com/dashboard/admin" style="color: ${colors.primary};">Admin Dashboard</a>
        </p>
    </div>
    
    <div class="footer">
        <p style="margin: 0 0 16px 0; font-weight: 600;">SaintsHub Admin Notifications</p>
        <div class="footer-links">
            <a href="https://saintshub.com/dashboard/admin">Admin Dashboard</a>
            <a href="https://saintshub.com/contact">Support</a>
        </div>
    </div>
  `;
  
  return emailWrapper(content, `Storage upgrade request from ${userName}`);
};

// 8. Storage Plan Updated Email (sent to user)
export const storagePlanUpdatedTemplate = (
  userName: string,
  oldPlan: string,
  newPlan: string
) => {
  ...
  const planDetails: Record<string, { storage: string; emoji: string }> = {
    free: { storage: '500 MB', emoji: '📦' },
    basic: { storage: '5 GB', emoji: '📁' },
    pro: { storage: '50 GB', emoji: '🚀' },
    unlimited: { storage: 'Unlimited', emoji: '♾️' }
  };
  
  const newDetails = planDetails[newPlan] || planDetails.free;
  const isUpgrade = ['free', 'basic', 'pro', 'unlimited'].indexOf(newPlan) > ['free', 'basic', 'pro', 'unlimited'].indexOf(oldPlan);
  
  const content = `
    <div class="header" style="background: linear-gradient(135deg, ${isUpgrade ? colors.success : colors.primary} 0%, ${isUpgrade ? '#059669' : '#4f46e5'} 100%);">
        <div class="logo">
            <img src="${logoUrl}" alt="SaintsHub Logo">
        </div>
        <h1 class="header-title">${isUpgrade ? 'Plan Upgraded!' : 'Storage Plan Updated'}</h1>
    </div>
    ...
    <div class="content">
        ...
        <p class="message">
            ${isUpgrade 
              ? 'Great news! Your SaintsHub storage plan has been upgraded. You now have more space for your church content.'
              : 'Your SaintsHub storage plan has been updated. Here are your new plan details.'
            }
        </p>
        
        <div class="${isUpgrade ? 'success-box' : 'info-box'}">
            <strong>${newDetails.emoji} New Plan: ${newPlan.toUpperCase()}</strong>
            <table style="width: 100%; margin-top: 12px; border-collapse: collapse;">
                <tr>
                    <td style="padding: 6px 0; color: ${colors.text.muted};"><strong>Previous Plan:</strong></td>
                    <td style="padding: 6px 0; color: ${colors.text.dark};">${oldPlan.toUpperCase()}</td>
                </tr>
                <tr>
                    <td style="padding: 6px 0; color: ${colors.text.muted};"><strong>New Plan:</strong></td>
                    <td style="padding: 6px 0; color: ${colors.text.dark}; font-weight: 600;">${newPlan.toUpperCase()}</td>
                </tr>
                <tr>
                    <td style="padding: 6px 0; color: ${colors.text.muted};"><strong>Storage Limit:</strong></td>
                    <td style="padding: 6px 0; color: ${colors.text.dark}; font-weight: 600;">${newDetails.storage}</td>
                </tr>
            </table>
        </div>
        
        <p class="message">
            Your updated storage is effective immediately. You can check your current usage anytime in the dashboard.
        </p>
        
        <div class="divider"></div>
        
        <p class="small-text">
            <strong>Questions about your plan?</strong><br>
            Contact us at 
            <a href="mailto:support@saintshub.net" style="color: ${colors.primary};">support@saintshub.net</a>
        </p>
    </div>
    ...
    <div class="footer">
        <p style="margin: 0 0 16px 0; font-weight: 600;">SaintsHub Team</p>
        <p class="small-text" style="opacity: 0.8;">
            Thank you for being part of SaintsHub!
        </p>
        <div class="footer-links">
            <a href="https://saintshub.com/dashboard">Dashboard</a>
            <a href="https://saintshub.com/contact">Contact Us</a>
  ...
  return emailWrapper(content, `Your storage plan has been ${isUpgrade ? 'upgraded' : 'updated'} to ${newPlan.toUpperCase()}`);
};

// 9. Storage Upgrade Rejected Email Template
export const storageUpgradeRejectedTemplate = (
  userName: string,
  currentPlan: string,
  requestedPlan: string
) => {
  ...
  const planDetails: Record<string, { storage: string }> = {
    free: { storage: '500 MB' },
    basic: { storage: '5 GB' },
    pro: { storage: '50 GB' },
  ...
  const content = `
    <div class="header" style="background: linear-gradient(135deg, ${colors.dark} 0%, #111827 100%);">
        <div class="logo">
            <img src="${logoUrl}" alt="SaintsHub Logo">
        </div>
        <h1 class="header-title">Upgrade Request Update</h1>
    </div>
    ...
    <div class="content">
        ...
        <p class="message">
            Thank you for your interest in upgrading your SaintsHub storage plan. After review, your request to upgrade to the <strong>${requestedPlan.toUpperCase()}</strong> plan was not approved at this time.
        </p>
        ...
        <div class="info-box">
            ...
            <table style="width: 100%; margin-top: 12px; border-collapse: collapse;">
                <tr>
                    <td style="padding: 6px 0; color: ${colors.text.muted};"><strong>Current Plan:</strong></td>
                    <td style="padding: 6px 0; color: ${colors.text.dark};">${currentPlan.toUpperCase()} (${currentDetails.storage})</td>
                </tr>
                <tr>
                    <td style="padding: 6px 0; color: ${colors.text.muted};"><strong>Requested Plan:</strong></td>
                    <td style="padding: 6px 0; color: ${colors.text.dark};">${requestedPlan.toUpperCase()}</td>
                </tr>
                <tr>
                    <td style="padding: 6px 0; color: ${colors.text.muted};"><strong>Status:</strong></td>
                    <td style="padding: 6px 0; color: #DC2626; font-weight: 600;">Not Approved</td>
                </tr>
            </table>
        </div>
        
        <p class="message">
            You can continue using your current <strong>${currentPlan.toUpperCase()}</strong> plan with ${currentDetails.storage} of storage. If you believe this decision was made in error or have additional information to share, please reach out to our team.
        </p>
  ...
  return emailWrapper(content, `Your upgrade request to ${requestedPlan.toUpperCase()} was not approved`);
};

// 10. Admin Reply Email Template (generic message from admin to user)
export const adminReplyTemplate = (
  ...
  const content = `
    <div class="header" style="background: linear-gradient(135deg, ${colors.dark} 0%, #111827 100%);">
        ...
        <h1 class="header-title">SaintsHub Team</h1>
    </div>
    
    <div class="content">
        <p class="greeting">Hello ${userName},</p>
        
        <div style="font-size: 16px; line-height: 1.7; color: ${colors.text.dark}; margin-bottom: 24px;">
            ${htmlMessage}
        </div>
        ...
        <p class="small-text">
            This email was sent by the SaintsHub admin team. If you have questions, simply reply to this email.
        </p>
    </div>
